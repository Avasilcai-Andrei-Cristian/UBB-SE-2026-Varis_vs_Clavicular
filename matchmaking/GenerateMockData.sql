-- ============================================================
-- Mock Data Generation Script for Matchmaking Database
-- Only populates SQL tables (7 tables from finalSQL.sql).
-- User, Company, Job, Skill, JobSkill are IN-MEMORY only.
--
-- In-memory ID ranges (from *Repository.cs hardcoded data):
--   Users:     1-20
--   Companies: 1-10
--   Jobs:      1-12, 100-104
--   DeveloperIDs: generated by identity (1-20 after this script)
--
-- Run with: sqlcmd -S "localhost\SQLEXPRESS" -d matchmaking -i GenerateMockData.sql -E
-- ============================================================
...
-- ============================================================
-- STEP 1: Clear all SQL tables (FK-safe order: children first)
-- ============================================================
...
-- ============================================================
-- STEP 2: Developers (20 rows -> DeveloperIDs 1-20)
-- ============================================================
...
-- ============================================================
-- STEP 3: Posts (40 rows -> PostIDs 1-40)
-- Developer proposals for algorithm parameter tuning.
-- Parameter values must match PostParameterTypeMapper storage strings.
-- ============================================================
...
-- ============================================================
-- STEP 4: Interactions (likes/dislikes on posts)
-- Type is BIT: 0 = Dislike, 1 = Like
-- ============================================================
...
-- ============================================================
-- STEP 5: Matches (users applied/matched to jobs)
-- Status: 'Pending', 'Accepted', 'Rejected', 'Advanced'
-- UserIDs: 1-10 (in-memory), JobIDs: 1-12,100-104 (in-memory)
-- ============================================================
