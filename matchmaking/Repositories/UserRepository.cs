...
public class UserRepository
{
    ...
    [
        ...
        new() { UserId = 11, Name = "Katerina Lupu", Location = "Cluj-Napoca", Email = "katerina.lupu@mail.com", Phone = "0700000011", YearsOfExperience = 3, Education = "BSc Computer Science", Resume = "Mobile developer with Flutter and Kotlin experience", PreferredEmploymentType = "Full-time" },
        new() { UserId = 12, Name = "Lucian Barbu", Location = "Bucharest", Email = "lucian.barbu@mail.com", Phone = "0700000012", YearsOfExperience = 5, Education = "MSc Cybersecurity", Resume = "Security engineer with pen-testing and SIEM tools", PreferredEmploymentType = "Remote" },
        new() { UserId = 13, Name = "Maria Enescu", Location = "Timisoara", Email = "maria.enescu@mail.com", Phone = "0700000013", YearsOfExperience = 1, Education = "BSc Computer Science", Resume = "Recent grad with Java and Spring Boot projects", PreferredEmploymentType = "Internship" },
        new() { UserId = 14, Name = "Nicolae Grigorescu", Location = "Brasov", Email = "nicolae.grigorescu@mail.com", Phone = "0700000014", YearsOfExperience = 10, Education = "MSc Software Engineering", Resume = "Engineering manager, scaled teams from 5 to 30", PreferredEmploymentType = "Full-time" },
        new() { UserId = 15, Name = "Oana Cristea", Location = "Iasi", Email = "oana.cristea@mail.com", Phone = "0700000015", YearsOfExperience = 4, Education = "BSc Mathematics and CS", Resume = "Data engineer with Spark, Airflow, and SQL pipelines", PreferredEmploymentType = "Hybrid" },
        new() { UserId = 16, Name = "Pavel Dragomir", Location = "Oradea", Email = "pavel.dragomir@mail.com", Phone = "0700000016", YearsOfExperience = 2, Education = "BSc Informatics", Resume = "Backend developer with Go and PostgreSQL experience", PreferredEmploymentType = "Remote" },
        new() { UserId = 17, Name = "Raluca Stoica", Location = "Sibiu", Email = "raluca.stoica@mail.com", Phone = "0700000017", YearsOfExperience = 6, Education = "MSc AI", Resume = "Computer vision engineer with PyTorch and OpenCV", PreferredEmploymentType = "Full-time" },
        new() { UserId = 18, Name = "Stefan Marinescu", Location = "Constanta", Email = "stefan.marinescu@mail.com", Phone = "0700000018", YearsOfExperience = 3, Education = "BSc Computer Science", Resume = "Full-stack developer with Angular and .NET Core", PreferredEmploymentType = "Hybrid" },
        new() { UserId = 19, Name = "Teodora Voinea", Location = "Craiova", Email = "teodora.voinea@mail.com", Phone = "0700000019", YearsOfExperience = 2, Education = "BSc Computer Science", Resume = "Frontend developer with Vue.js and TypeScript", PreferredEmploymentType = "Full-time" },
        new() { UserId = 20, Name = "Vlad Petrescu", Location = "Cluj-Napoca", Email = "vlad.petrescu@mail.com", Phone = "0700000020", YearsOfExperience = 7, Education = "MSc Cloud Computing", Resume = "Cloud architect with AWS and Azure certifications", PreferredEmploymentType = "Remote" }
    ];
